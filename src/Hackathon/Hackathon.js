...
const timelineEvents = [
  {
    ...
    desc: "Start forming your team and work on your project.",
  },
  {
    date: "5th - 26th January, 2026",
    title: "Submission Window",
    desc: "Submit the prototype of your project.",
  },
  {
    date: "28th January, 2026",
    title: "Result Announcement",
    desc: "Announcement of shortlisted teams for the final pitch round.",
  },
  {
    date: "31st January, 2026",
    title: "Final Pitch and Judgement",
    desc: "D-Day: Selected top 8 teams per problem statement pitch their projects to judges, demonstrating the functionality and potential impact of their solution.",
  },
];

const faqs = [
  {
    question: "Are cross-college and cross-specialization teams allowed?",
    answer:
      "Yes. Teams may include members from different colleges and different academic specializations.",
  },
  {
    question: "Who can participate?",
    answer: (
      <>
        The hackathon is open to students and early innovators with an interest
        in finance and technology.<ol>Team Size: 1 to 4 members</ol>
      </>
    ),
  },
  {
    ...
    answer:
      "Yes. Teams must submit at least a basic working prototype or functional demo that clearly demonstrates the idea and core features of the solution.",
  },
  {
    question: "Is the pitch deck mandatory?",
    answer:
      "The pitch deck is strictly mandatory. It must be 5–7 slides only and should clearly explain the problem, solution, technology and impact.",
  },
  {
    question: "Can we submit projects built before the hackathon?",
    answer:
      "No. All submissions must be built during the hackathon period. Any reuse of old projects must be clearly disclosed and should not form the majority of the solution.",
  },
  {
    question: "Can a team participate in multiple problem statements?",
    answer:
      "No. Each team can submit only one project under one problem statement.",
  },
  {
    question: "How to create a team ?",
    answer:
      "Once you apply to Devfolio you can either apply as a solo team or a team of upto 2-4 members. If you apply as a solo team, wait for your application to get accepted. Once your application is accepted you can join or create a team. If you want to apply as a team then select create a team or join a team by entering the referral link. Once all team members join you can submit your application and wait for it to get reviewed. You can only submit your project once your application gets accepted.",
  },
  {
...
const problemStatements = [
  {
    title: "OnChain Rewards - Blockchain (OnChain Rewards)",
    icon: <FaCreditCard />,
    desc: (
      <>
        Reimagine financial trust using blockchain. Build a secure, on-chain
        credibility system that verifies multiple user trust metrics and unlocks
        real-time rewards across e-commerce, travel, fintech, and lifestyle
        platforms.
      </>
    ),
  },
  {
    title: "Offroad Semantic Scene Segmentation Challenge",
    icon: <FaRobot />,
    desc: (
      <>
  ...
  {
    title: "Hostel Life Utility Manager - UI/UX Beginner Track (Freshers Only)",
    icon: <FaUserGraduate />,
    desc: (
      <>
        Simplify hostel finances. Design an intuitive budgeting app that helps
        students track expenses, split bills, manage shared utilities, and avoid
        end-of-month money stress through clean UI and smart reminders.
      </>
    ),
  },
  {
    title: "Financial Games & Finopoly - Game Development",
    icon: <FaGamepad />,
    desc: (
      <>
        Turn finance into fun. Create a finance-inspired game where earning,
        spending, trading, and risk drive gameplay, helping players learn
        financial concepts through strategy, storytelling, and interaction.
      </>
    ),
  },
  {
    title: "Quantifying the Markets - Machine Learning",
    icon: <FaChartLine />,
    desc: (
      <>
        Decode market data with machine learning. Analyze real-world financial
        datasets to identify trends, volatility, and short-term forecasts,
        focusing on strong quantitative reasoning and clear insights.
      </>
    ),
  },
  {
    ...
    desc: (
      <>
        No rules, no limits. Bring bold, unconventional ideas that redefine
        finance - whether through health, accessibility, blockchain, or any
...
const Hackathon = () => {
  ...
  useEffect(() => {
    ...
    gsap.from(
      [
        ".hackathonhero-title",
        ".hackathonhero-subtitle",
        ".hackathonhero-button",
      ],
      {
        opacity: 0,
        y: 50,
  ...
  const prevProblem = () => {
    setCurrentIndex((prev) =>
      prev === 0 ? problemStatements.length - 1 : prev - 1,
    );
  };
    ...
    <div className="hackathon-container">
      ...
      <section id="" className="hackathonhero">
        ...
        <div className="crypto-icons">
          ...
          <div className="crypto-icon litecoin">
            <SiLitecoin size={40} />
          </div>
        ...
        <h1 className="hackathonhero-title">
          The Future of <span>Innovation</span>
        </h1>
      ...
      <section id="about" className="about">
        ...
        <div className="about-container">
          ...
          <p className="about-text">
            This hackathon is designed to push the boundaries of innovation,
            bringing together the best minds in the industry.
          </p>
        </div>
      </section>
        ...
        <div className="tracks-body">
          <div className="tracks-container">
            ...
            <div className="tracks-content">
              <div
                className={`tracks-contentBx ${activeContent === "content1" ? "active" : ""}`}
                id="content1"
              >
              ...
              <div
                className={`tracks-contentBx ${activeContent === "content2" ? "active" : ""}`}
                id="content2"
              >
                <div className="tracks-card">
                  <div className="tracks-imgBx">
              ...
              <div
                className={`tracks-contentBx ${activeContent === "content3" ? "active" : ""}`}
                id="content3"
              >
                <div className="tracks-card">
                  <div className="tracks-imgBx">
              ...
              <div
                className={`tracks-contentBx ${activeContent === "content4" ? "active" : ""}`}
                id="content4"
              >
                <div className="tracks-card">
                  <div className="tracks-imgBx">
              ...
              <div
                className={`tracks-contentBx ${activeContent === "content5" ? "active" : ""}`}
                id="content5"
              >
                <div className="tracks-card">
                  <div className="tracks-imgBx">
              ...
              <div
                className={`tracks-contentBx ${activeContent === "content6" ? "active" : ""}`}
                id="content6"
              >
                <div className="tracks-card">
                  <div className="tracks-imgBx">
