  ...
  return (
    <div className="Youtube">
        ...
        <div class="resourcesbox">
          ...
          <div class="boxsmall">
            <a target="_blank" rel="noreferrer" href="https://open.spotify.com/episode/7vHHGxrlU890tlJXUasi9X?si=b5ebd680d07b46d7">
          ...
          <div class="boxsmall">
            <a target="_blank" rel="noreferrer" href="https://open.spotify.com/show/1ZpUmASkxeRmJsukPXWQT2?si=U8ebq-obRaCNzxnMTI3_zg">
              <div class="img podcast">
                <img src={SpotifyLogo} alt="Cover"/>
              </div>
              <div class="text">
