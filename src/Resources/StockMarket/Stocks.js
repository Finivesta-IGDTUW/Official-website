  ...
  return (
    ...
    <div className="box">
        <a href="https://fortune.com/recommends/investing/how-to-start-investing/" class="box-link">
            <div className="box1">
                ...
                <div className="img">
                    <img src="How to start investing .jpeg" alt="Budgeting" />
                </div>
                <div className="text">
        ...
        <a href="https://www.reddit.com/r/IndiaInvestments/comments/9ltgni/for_someone_who_is_absolutely_at_level_zero_in/" class="box-link">
            <div className="box1">
                <div className="img">
                  <img src="Investing for someone who is at level zero.jpeg" alt="Investing" />
                </div>
                <div className="text">
        ...
        <a href="https://www.fool.com/investing/stock-market/types-of-stocks/" class="box-link">
            <div className="box1">
                <div className="img">
                  <img src="types of stocks.jpeg" alt="Stock/Share Market" />
                </div>
                <div className="text">
    ...
    <div className="box">
        <a href="https://www.forbes.com/advisor/investing/what-are-stocks/" class="box-link">
            <div className="box1">
                <div className="img">
                  <img src="what are stocks.jpg" alt="Crypto" />
                </div>
                <div className="text">
        ...
        <a href="https://www.reddit.com/r/IndiaInvestments/comments/k7v0dg/a_beginners_guide_to_investing_in_the_stock/" class="box-link">
            <div className="box1">
                <div className="img">
                  <img src="Beginners guide to investing .jpeg" alt="Financial Literacy" />
                </div>
                <div className="text">
        ...
        <a href="https://www.investopedia.com/terms/s/stock.asp" class="box-link">
            <div className="box1">
                <div className="img">
                  <img src="stocksvsbonds.jpg" alt="Bidding" />
                </div>
                <div className="text">
