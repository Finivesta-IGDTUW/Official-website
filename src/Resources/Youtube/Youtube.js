  ...
  return (
    <div className="Youtube">
        ...
        <div class="resourcesbox">
          ...
          <div class="boxsmall">
            <a href="https://youtube.com/playlist?list=PL8uhW8cclMiNv8UT1NUawB-XpXVeJ8mN8&si=Ciaw9fblNEHPSF7b">
            <div class="img video">
          ...
          <div class="boxsmall">
            <a href="https://youtu.be/p7HKvqRI_Bo?si=5mUfxdUkvOX995-c">
            <div class="img video">
          ...
          <div class="boxsmall">
            <a href="https://youtu.be/JZk6T1TmIrs?si=rTXUZBOx48Fd3bUC">
            <div class="img video">
